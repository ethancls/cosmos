...
nameserver 10.0.0.1
nameserver 8.8.8.8
searchdomain cosmos.cloud something`,
...
nameserver 10.0.0.1
nameserver 8.8.8.8
searchdomain cosmos.cloud something somethingelse`,
			wantChange: false,
		},
		{
			resolvConfContent: `
...
nameserver 8.8.8.8`,
	...
	for _, tt := range tests {
		...
		t.Run("test", func(t *testing.T) {
			...
			r.watchFileChanges([]string{"cosmos.cloud"}, netip.MustParseAddr("10.0.0.1"), nil)
