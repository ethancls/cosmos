...
func getSetupRules() []ruleParams {
	return []ruleParams{
		...
		{110, nbnet.ControlPlaneMark, NetbirdVPNTableID, netlink.FAMILY_V4, true, -1, "rule v4 cosmos"},
		{110, nbnet.ControlPlaneMark, NetbirdVPNTableID, netlink.FAMILY_V6, true, -1, "rule v6 cosmos"},
	}
}
...
// and verifies if existing names start with "cosmos_".
