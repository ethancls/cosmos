...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting Cosmos service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped Cosmos service") //nolint
	return nil
}
...
var startCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Cosmos service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Cosmos service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Cosmos service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows Cosmos service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		...
		cmd.Printf("Cosmos service status: %s\n", statusText)
		return nil
	},
}
