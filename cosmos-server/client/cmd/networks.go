...
var networksCMD = &cobra.Command{
	...
	Short:   "Manage connections to Cosmos Networks and Resources",
...
var routesSelectCmd = &cobra.Command{
	...
	Example: "  cosmos networks select all\n  cosmos networks select route1 route2\n  cosmos routes select -a route3",
...
var routesDeselectCmd = &cobra.Command{
	...
	Example: "  cosmos networks deselect all\n  cosmos networks deselect route1 route2",
	Args:    cobra.MinimumNArgs(1),
