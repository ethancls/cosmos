  ...
  ],
  {
    variants: {
      variant: {
        ...
        primary: [
          "dark:focus:ring-kyle-600/50 dark:ring-offset-neutral-950/50 enabled:dark:bg-kyle disabled:dark:bg-nb-gray-910 dark:text-gray-100 enabled:dark:hover:text-white enabled:dark:hover:bg-kyle-500/80",
          "enabled:bg-kyle enabled:text-white enabled:focus:ring-kyle-400/50 enabled:hover:bg-kyle-500",
        ],
        secondary: [
          "bg-white hover:text-black focus:ring-zinc-200/50 hover:bg-gray-100 border-gray-200 text-gray-900",
        ...
        "danger-outline": [
          "bg-transparent text-red-500 focus:ring-red-500/20 hover:bg-red-50 hover:border-red-300",
        ...
        "danger-text": [
          "bg-transparent text-red-500 hover:text-red-600 border-transparent !px-0 !shadow-none !py-0 focus:ring-red-500/30 ring-offset-white dark:ring-offset-neutral-950/50 rounded-sm",
          "dark:text-red-500 dark:hover:text-red-600",
        ],
        "default-outline": [
          ...
          "data-[state=open]:text-gray-900 data-[state=open]:bg-gray-100 data-[state=open]:dark:text-white data-[state=open]:dark:bg-nb-gray-900/30 data-[state=open]:dark:border-nb-gray-800/50",
        ],
        danger: [
          "focus:ring-red-500/20 bg-red-600 text-white hover:bg-red-700 border-red-600",
