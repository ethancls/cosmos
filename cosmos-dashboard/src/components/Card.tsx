...
function CardListItem({
  ...
  return (
    <li
      className={cn(
        "flex justify-between px-4 border-b border-gray-200 dark:border-nb-gray-900 py-3.5 last:border-b-0 items-center h-full",
        className,
      )}
    >
...
const CardTextItem = ({
  ...
  return (
    <div
      className={cn(
        "text-right text-gray-500 dark:text-nb-gray-400 text-[0.84rem] flex items-center gap-2",
