    ...
    <div className={"flex flex-col items-center justify-center mt-3"}>
      <div className="relative h-10 w-10 mt-4">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="h-10 w-10 rounded-full bg-cosmos/10 border border-cosmos/60 animate-slow-ping "></div>
        </div>
        <div className="absolute top-1/2 left-1/2 h-4 w-4 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cosmos z-10" />
      </div>
