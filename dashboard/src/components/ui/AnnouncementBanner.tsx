  ...
  {},
  {
    variants: {
      variant: {
        ...
        important:
          "from-cosmos to-cosmos-400 bg-gradient-to-b text-black font-normal",
      },
      tagBadge: {
      ...
      closeButton: {
        ...
        important:
          "bg-cosmos rounded-md p-1 text-nb-gray-900 hover:bg-nb-gray-900 hover:text-nb-gray-200",
      },
      inlineLink: {
