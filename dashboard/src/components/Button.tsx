  ...
  ],
  {
    variants: {
      variant: {
        ...
        primary: [
          "dark:focus:ring-cosmos-600/50 dark:ring-offset-neutral-950/50 enabled:dark:bg-cosmos disabled:dark:bg-nb-gray-910 dark:text-gray-100 enabled:dark:hover:text-white enabled:dark:hover:bg-cosmos-500/80",
          "enabled:bg-cosmos enabled:text-white enabled:focus:ring-cosmos-400/50 enabled:hover:bg-cosmos-500",
        ],
        secondary: [
          "bg-white hover:text-black focus:ring-zinc-200/50 hover:bg-gray-100 border-gray-200 text-gray-900",
        ...
        outline: [
          "bg-white hover:text-black focus:ring-zinc-200/50  hover:bg-gray-100 border-gray-200 text-gray-900",
          "dark:focus:ring-zinc-800/50 dark:bg-transparent dark:text-cosmos dark:border-cosmos dark:hover:bg-nb-gray-900/30",
        ],
        "danger-outline": [
