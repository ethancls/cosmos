...
const AssistantAvatar = () => {
  return (
    <div
      className={
        "w-8 h-8 shrink-0 p-[2px] rounded-full relative flex overflow-hidden items-center justify-center text-white uppercase text-[14px] leading-[0] font-medium bg-kyle-deep-900"
      }
    >
      <span
      ...
      >
        <KyleIcon size={17} className={"top-[1px] relative"} />
      </span>
    </div>
  );
};
...
const LoadingAvatar = () => {
  return (
    <div
      className={
        "w-8 h-8 shrink-0 rounded-full relative flex items-center justify-center text-white uppercase text-[14px] leading-[0] font-medium bg-kyle-deep-900"
      }
    >
      <Loader2 size={16} className={"text-kyle-deep-100 animate-spin"} />
    </div>
  );
};
