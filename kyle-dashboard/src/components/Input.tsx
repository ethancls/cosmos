...
const inputVariants = cva("", {
  variants: {
    variant: {
      ...
      darker: [
        "bg-gray-50 dark:bg-nb-gray-920 dark:placeholder:text-neutral-400/70 placeholder:text-neutral-500 border-neutral-300 dark:border-nb-gray-800",
        "ring-offset-neutral-200/20 dark:ring-offset-neutral-950/50 dark:focus-visible:ring-neutral-500/20 focus-visible:ring-neutral-300/10",
      ],
      error: [
    ...
    prefixSuffixVariant: {
      default: [
        "dark:bg-nb-gray-900 border-neutral-200 dark:border-nb-gray-700 text-gray-500 dark:text-nb-gray-300",
      ],
      error: [
        "dark:bg-nb-gray-900 border-red-500 text-gray-500 dark:text-nb-gray-300 text-red-500",
      ],
    },
  },
});
        ...
        <div className={cn("flex relative h-[42px]", maxWidthClass)}>
          ...
          <input
            ...
            className={cn(
              ...
              "border",
              props.readOnly &&
                "!bg-gray-100 dark:!bg-nb-gray-920 text-gray-500 dark:text-nb-gray-400 !border-gray-300 dark:!border-nb-gray-800",
              className,
            )}
          />
