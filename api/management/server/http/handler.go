...
import (
	...
	"github.com/ethancls/cosmos/management/internals/modules/reverseproxy/domain/manager"
	...
	"github.com/ethancls/cosmos/management/internals/modules/reverseproxy/proxytoken"
	"github.com/ethancls/cosmos/management/internals/modules/reverseproxy/service"
	reverseproxymanager "github.com/ethancls/cosmos/management/internals/modules/reverseproxy/service/manager"

	nbgrpc "github.com/ethancls/cosmos/management/internals/shared/grpc"
	idpmanager "github.com/ethancls/cosmos/management/server/idp"
	...
	zonesManager "github.com/ethancls/cosmos/management/internals/modules/zones/manager"
	"github.com/ethancls/cosmos/management/internals/modules/zones/records"
	recordsManager "github.com/ethancls/cosmos/management/internals/modules/zones/records/manager"
	...
	"github.com/ethancls/cosmos/management/server/http/handlers/proxy"

	"github.com/ethancls/cosmos/management/server/auth"
	"github.com/ethancls/cosmos/management/server/geolocation"
	nbgroups "github.com/ethancls/cosmos/management/server/groups"
	"github.com/ethancls/cosmos/management/server/http/handlers/accounts"
	"github.com/ethancls/cosmos/management/server/http/handlers/dns"
	"github.com/ethancls/cosmos/management/server/http/handlers/events"
	"github.com/ethancls/cosmos/management/server/http/handlers/groups"
	"github.com/ethancls/cosmos/management/server/http/handlers/idp"
	"github.com/ethancls/cosmos/management/server/http/handlers/instance"
	"github.com/ethancls/cosmos/management/server/http/handlers/networks"
	"github.com/ethancls/cosmos/management/server/http/handlers/peers"
	"github.com/ethancls/cosmos/management/server/http/handlers/policies"
	"github.com/ethancls/cosmos/management/server/http/handlers/routes"
	"github.com/ethancls/cosmos/management/server/http/handlers/setup_keys"
	"github.com/ethancls/cosmos/management/server/http/handlers/users"
	...
	nbnetworks "github.com/ethancls/cosmos/management/server/networks"
