...
const (
	...
	msiDownloadURL = "https://github.com/ethancls/cosmos/releases/download/v%version/netbird_installer_%version_windows_%arch.msi"
	exeDownloadURL = "https://github.com/ethancls/cosmos/releases/download/v%version/netbird_installer_%version_windows_%arch.exe"
)
